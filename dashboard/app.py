...
<div style="display:flex; align-items:center; gap:16px; margin-bottom:22px;">
    ...
    ">🛡️</div>
    <div>
        <div style="font-size:26px; font-weight:800; color:#f8fafc; letter-spacing:0.3px; font-family:'Outfit',sans-serif;">
            Inbox Guardian
        </div>
...
<p style="color:#94a3b8; font-size:14px; line-height:1.7; margin-bottom:24px; margin-top:0;">
...
<div style="display:flex; flex-wrap:wrap; gap:8px; margin-bottom:24px;">
    ...
    <span style="background:rgba(139,92,246,0.1); border:1px solid rgba(139,92,246,0.25); color:#a78bfa; border-radius:20px; padding:5px 13px; font-size:12px; font-weight:600;">Streamlit</span>
    <span style="background:rgba(52,211,153,0.1); border:1px solid rgba(52,211,153,0.25); color:#34d399; border-radius:20px; padding:5px 13px; font-size:12px; font-weight:600;">Google Gemini API</span>
    <span style="background:rgba(251,146,60,0.1); border:1px solid rgba(251,146,60,0.25); color:#fb923c; border-radius:20px; padding:5px 13px; font-size:12px; font-weight:600;">Gmail OAuth2</span>
    <span style="background:rgba(248,113,113,0.1); border:1px solid rgba(248,113,113,0.25); color:#f87171; border-radius:20px; padding:5px 13px; font-size:12px; font-weight:600;">scikit-learn</span>
    <span style="background:rgba(251,191,36,0.1); border:1px solid rgba(251,191,36,0.25); color:#fbbf24; border-radius:20px; padding:5px 13px; font-size:12px; font-weight:600;">Plotly</span>
